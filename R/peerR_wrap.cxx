...
R_swig_new_cWNodeSparse__SWIG_0 ( )
{
  ...
  r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_PEER__cWNodeSparse, SWIG_POINTER_OWN |  0 );
  vmaxset(r_vmax);
  if(r_nprotect)  Rf_unprotect(r_nprotect);
...
R_swig_new_cEpsNodeSparse ( SEXP dim, SEXP pa, SEXP pb, SEXP E1)
{
  ...
  r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_PEER__cEpsNodeSparse, SWIG_POINTER_OWN |  0 );
...
R_swig_new_PEER ( )
{
  ...
  r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_PEER__cSPARSEFA, SWIG_POINTER_OWN |  0 );
  vmaxset(r_vmax);
  if(r_nprotect)  Rf_unprotect(r_nprotect);
